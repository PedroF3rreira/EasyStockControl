<aside class="side-bar-area">
	<ul>
		<li class='active'><a href="<?=$base?>/"><span class="material-icons-outlined">cottage</span>Inicio</a></li>
		<li><a href="<?=$base;?>/produto/cadastro"><span class="material-icons-outlined">add</span>Cadastro</a></li>
		...
		<li><a href="#"><span class="material-icons-outlined">face</span>Cadastro Fornecedores</a></li>
