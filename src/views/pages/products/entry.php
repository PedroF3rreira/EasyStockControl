...
<div class="container-areas">
	...
	<section class="register content-area1">	
		...
		<form method="POST" class="form" action="<?=$base;?>/produto/entrada">
			<?php if(!empty($flash)):?>
				<div class="flash">
					<?=$flash;?>
				</div>
		...
		<form method="POST" class="form" action="<?=$base;?>/produto/entrada/<?=$product->id;?>">
			<div class="form-control">
				<label>Codigo:</label>
			...
			<div class="form-control">
				...
				<input type="text" name="entry"  min="1" size="2" required>
			</div>
